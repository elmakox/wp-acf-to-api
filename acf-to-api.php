...
/**
  Plugin Name: ACF TO API
  Plugin URI: https://godwinelitcha.com/
  Description: Add data from Advanced Custom Fields to the Wordpress REST API.
  Version: 1.0.0
  Author: Godwin ELITCHA
 *
 */
